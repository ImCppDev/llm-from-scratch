...
4. Write 3–5 sentences in `notes.md`: what you expected, what happened,
   why.
...
(e.g. "uv run check.py passes", "loss decreases below X", "you can
explain in your notes why removing residuals breaks training").

## Files in this lesson
- `lesson.py` — starter code, implement the TODOs
- `check.py` — run this to verify your implementation (if present)
- `notes.md` — write your findings here (create if not present)
